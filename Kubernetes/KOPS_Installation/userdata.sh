...
# Update system
echo -e "\e[32mUpdating system packages...\n\e[0m" | tee -a ${LOG_FILE}
sudo apt-get update -y &>> ${LOG_FILE}

# Download and install kops
echo -e "\e[32mInstalling kops...\n\e[0m" | tee -a ${LOG_FILE}
...
echo -e "\e[32mInstalling kubectl...\n\e[0m" | tee -a ${LOG_FILE}
...
echo -e "\e[32mConfiguring environment variables and alias...\n\e[0m" | tee -a ${LOG_FILE}
...
echo -e "\e[32mCreating cluster deployment directory at $DEPLOYMENT_DIR...\n\e[0m" | tee -a ${LOG_FILE}
sudo mkdir -p ${DEPLOYMENT_DIR} &>> ${LOG_FILE}

# Generate cluster.yaml for deployment
echo -e "\e[32mGenerating cluster.yaml configuration...\n\e[0m" | tee -a ${LOG_FILE}
